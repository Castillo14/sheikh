...
?>
			<section class="content-header">
	    		...
	    		<section class="content">
					<form action="../PHPExcel/Examples/bol_info_search.php" method="POST">
						<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && dispatcher_bol=<?php echo $bus_company; ?> && getRefresh=<?php echo $getUpdate; ?>" class="btn btn-default">
	              					...
	              					<h3 class="box-title"><i class="fa fa-money"></i><?php echo $e_name; ?> BOL
	              						<span>
	              							<a class="btn-sm btn-primary navbar-btn right" href="#"><!-- btn btn-primary navbar-btn right Starts -->
	            								...
	            								$total = "SELECT * FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
	            				...
	            				<div class="box-body table-responsive no-padding">
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<?php
	                						...
	                						$select_company = "SELECT * FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
	                						...
	                						while($row=mysqli_fetch_array($run_select_company)){
							                    ...
							                    $select_amount = "SELECT SUM(bol_amount) AS total_amount FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
		                						...
		                						$select_comp = "SELECT SUM(comp) AS total_comp FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
		                						...
		                						$select_ipon = "SELECT SUM(ipon) AS total_ipon FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
		                						...
		                						$select_crew = "SELECT SUM(crew) AS total_crew FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
		                						...
		                						$select_dispatcher = "SELECT SUM(dispatcher) AS total_dispatcher FROM tbl_bol WHERE bus_company_id = '$bus_company' AND date_created BETWEEN '$one' AND '$two'";
