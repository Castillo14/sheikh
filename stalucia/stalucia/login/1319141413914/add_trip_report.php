                ...
                <form class="form-horizontal" autocomplete="off" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                  ...
                  <div class="form-group"><!-- form-group Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <input type="text" name="nb_" class="form-control">
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="sb_" class="form-control">
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="fix" class="form-control">
                        </div>
                    </div><!-- form-group Ends -->
                     <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="nof" class="form-control">
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
...
<?php
        if(isset($_POST['submit'])){
            ...
            $nb_ = mysqli_real_escape_string($con,$_POST['nb_']);
            $sb_ = mysqli_real_escape_string($con,$_POST['sb_']);
            $fix = mysqli_real_escape_string($con,$_POST['fix']);
            $nof = mysqli_real_escape_string($con,$_POST['nof']);
            $insert_trip = "INSERT INTO tbl_trip_report (bus_id,tor_number,bus_company_id,driver_id,conductor_id,depart_from,time_depart,arrive_to,time_arrive,round_trip,trip_number,nb,sb,nb_baggage,sb_baggage,diesel_fixrate,nof,created_by,date_created) VALUES ('$bus_number','$tor','$edit_id','$driver','$conductor','$depart_from','$time_depart','$arrive_to','$time_arrive','$km','$tn','$nb','$sb','$nb_','$sb_','$fix','$nof','$creator','$dt')";
