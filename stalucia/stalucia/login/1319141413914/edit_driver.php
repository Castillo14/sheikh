...
<?php
	...
	if(isset($_GET['edit_driver'])){
		...
		$edit_driver = "SELECT * FROM tbl_driver WHERE driver_id = '$edit_id' AND removed = 'No'";
		$run_edit = mysqli_query($con,$edit_driver);
		$row_edit = mysqli_fetch_array($run_edit);
		$e_id = $row_edit['driver_id'];
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && drivers=<?php echo $e_bus_company; ?> && getDrivers=<?php echo $getAdd; ?>" class="btn btn-danger form-control">
                                Cancel
                            </a>
                        </div>
                    </div><!-- form-group Ends -->
    ...
    <?php
    	if(isset($_POST['update'])){
            ...
            move_uploaded_file($temp_image, "../driver_conductor_images/$image");
                ...
                $update_driver = "UPDATE tbl_driver SET bus_company_id = '$bus_company', first_name = '$first_name', middle_name = '$middle_name', last_name = '$last_name', email_address = '$email_address', contact_number = '$contact_number', address = '$address', image = '$image' WHERE driver_id = '$e_id'";
            $run_update_driver = mysqli_query($con,$update_driver);
                ...
                if($run_update_driver){
                    ...
                    echo "
                        <script>
                            window.open('index.php?jScript=$jScript && newScript=$newScript && drivers=$bus_company && getDriver=$getAdd','_self')
                        </script>
                    ";
