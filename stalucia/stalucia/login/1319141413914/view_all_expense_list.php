<?php
	...
	if(isset($_GET['view_all_expense_list'])){
		...
		$category_id = $_GET['view_all_expense_list'];
...
?>
			<section class="content-header">
	    		...
	    		<section class="content">
	    			<a class="btn btn-default" href="index.php?add_edit_expense_list">
						<i class="fa fa-reply"></i>
						Back
					</a>
					<a href="../PHPExcel/Examples/view_all_expense_list.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && view_all_expense_list=<?php echo $category_id; ?> && getView=<?php echo $getUpdate; ?>" class="btn btn-default">
	    				<i class="fa fa-print"></i>
						Get Excel
	    			</a>
	    			<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && view_all_expense_list=<?php echo $category_id; ?> && getView=<?php echo $getUpdate; ?>" class="btn btn-default">
	    				<i class="fa fa-refresh"></i>
						Refresh
	    			</a>
	    			<form action="index.php?view_all_expense_list_search" method="POST" class="form-horizontal">
	              					...
	              					<h3 class="box-title"><i class="fa fa-industry"></i><?php echo $e_name; ?> List
	              						<span>
	              							<a class="btn-sm btn-primary navbar-btn right" href="#"><!-- btn btn-primary navbar-btn right Starts -->
	            								...
	            								$total = "SELECT * FROM tbl_trip_expense WHERE expenses_id = '$category_id'";
	            				...
	            				<div class="box-body table-responsive no-padding">
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<?php
	                						...
	                						$select_sum = "SELECT SUM(price) AS total_sum FROM tbl_trip_expense WHERE expenses_id = '$category_id'";
	                						...
	                						$select_company = "SELECT * FROM tbl_trip_expense WHERE expenses_id = '$category_id' ORDER BY bus_company_id";
