<div class="modal fade" id="add_expense3<?php echo $e_id; ?>" hidden="true" role="dialog">
	              		...
	              		<div class="row">
	              			<div class="box box-success">
	              				...
	              				<div class="box-body table-responsive no-padding">
	              					<form action="add_trip_expenses3.php" method="post" class="form-horizontal" enctype="multipart/form-data">
