...
<div class="modal fade" id="remove_diesel2<?php echo $diesel_id; ?>" hidden="true" role="dialog">
	        <div class="modal-dialog">
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		...
	              		?>
	    				<form class="form-horizontal" action="remove_trip_diesel2.php" method="post" enctype="multipart/form-data">
