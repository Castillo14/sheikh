								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
					                	...
					                	<ul class='nav nav-tabs'><!-- nav nav-tabs Starts -->
											...
											<li class=''>
					        					<a href='' id='btn4' data-toggle='tab'>
					            					<i class='fa fa-wrench'></i> <span>Work Order</span>
					        					</a>
					    					</li>
									...
									<div class='col-md-12'><!-- col-md-12 Starts -->
					                	...
					                	<div id='status_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
								        		<button class='btn btn-default' type='button' data-toggle='modal' data-target='#main_inventoryy<?php echo $e_id; ?>'>
														<i class='fa fa-plus'></i>
														Main Inventory
													</button>
												<button class='btn btn-default' type='button' data-toggle='modal' data-target='#malabon_inventory<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Malabon Inventory
												</button>
												...
												<button class='btn btn-default' type='button' data-toggle='modal' data-target='#other_maintenance<?php echo $e_id; ?>'>
													...
													Other Maintenance
									    			 ...
									    			 <?php
										            	...
										            	include("modal/main_inventory.php");

										            ?> 
										            <?php

										            	include("modal/malabon_inventory.php");
															...
															<table class="table table-hover ample2">
													            ...
													            <?php
													            	...
													            	while($row_bus_maintenancee = mysqli_fetch_array($run_bus_maintenancee)){
													            		...
													            		$destination = $row_bus_maintenancee['destination'];
										...
										<div id='work_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_work_order<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Add Work Order
												</button>
												...
												<?php
													            	...
													            	include("modal/add_work_order.php");

													            ?> 												<div class='row'><!-- row Starts -->
													<div class='box box-success'><!--box box-success Starts -->
														<div class='box-header'><!-- box-header Starts -->
															<h3 class='box-title'>
																<i class='fa fa-wrench'></i> Work Order
																<span>
																	<a class='btn-sm btn-success navbar-btn right' href='#''><!-- btn btn-primary navbar-btn right Starts -->
																		<?php

																			$get_maintenanceee = "SELECT * FROM tbl_work_order WHERE bus_id = '$e_id'";
														...
														<div class='box-body table-responsive no-padding'><!-- box-body table-responsive no-padding Starts -->
															<table class="table table-hover ample2">
													            ...
													            <?php
													            	...
													            	$get_bus_maintenanceee = "SELECT * FROM tbl_work_order WHERE  bus_id = '$e_id'";
													            	...
													            	while($row_bus_maintenanceee = mysqli_fetch_array($run_bus_maintenanceee)){
													            		...
													            		$ris_number = $row_bus_maintenanceee['ris_number'];


													            		$summary = $row_bus_maintenanceee['summary'];

													            		$remarks = $row_bus_maintenanceee['remarks'];

													            		$date_createdd = $row_bus_maintenanceee['date_created'];
													            		$i++;

													            ?>
													            	<tr>
													            		<td><?php echo $i; ?></td>
													            		<td><?php echo $ris_number; ?></td>
													            		<td><?php echo $summary; ?></td>
																		<td><?php echo $remarks; ?></td>
													            		<td><?php echo $date_createdd; ?></td>
													            	</tr>
