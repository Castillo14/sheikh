<div class="modal fade" id="add_note<?php echo $e_id; ?>" hidden="true" role="dialog">
	              		...
	              		<div class="row">
	              			<div class="box box-success">
	              				...
	              				<div class="box-body table-responsive no-padding">
	              					<form action="add_note.php" method="post" class="form-horizontal" enctype="multipart/form-data">
