...
<div class="modal fade" id="remove_expense3<?php echo $trp_exp; ?>" hidden="true" role="dialog">
	        <div class="modal-dialog">
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		...
	              		?>
	    				<form class="form-horizontal" action="remove_trip_expense3.php" method="post" enctype="multipart/form-data">
