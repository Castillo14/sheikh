								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
									...
									<div class='col-md-12'><!-- col-md-12 Starts -->
							                    <div class='form-group'>
							                        ...
							                        <div class='col-sm-6'>
						          						<a href='index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && drivers_attendance=<?php echo $bus_company_id; ?> && getTrip=<?php echo $getAdd; ?>' class='btn btn-default pull-left'><i class='fa fa-close'></i> Close</a>
						        					</div>
							                    </div>
							                </div>
					                	...
					                	<div id='status_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_expense2<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Add Expense
												</button>
												<?php

													            	include("modal/add_expense2.php");
													            ...
													            ?>
													            	<tr>
													            		...
													            		<td><?php echo $particulars; ?></td>
													                  	...
													                  	<td>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#remove_expense2<?php echo $trp_exp; ?>'>
													            	...
													            	include("modal/remove_expense2.php");
...
<div id='other_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_note2<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Add Note
												</button>
												<?php 
...
Get Excel
														...
														<div class='box-body table-responsive no-padding'><!-- box-body table-responsive no-padding Starts -->
															<table class="table table-hover ample2">
													            ...
													            ?>
													            	...
													            	<td>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#remove_info2<?php echo $info_id; ?>'>
					                  											<i class='fa fa-trash-o'></i>
					                  										</button>
													                  	</td>
													            	</tr>
													            	...
													            	include("modal/remove_info2.php");
 ...
 <div id='diesel_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_diesel2<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Add Diesel
												</button>
												<?php 
													            ...
													            ?>
													            	<tr>
													            		...
													            		<td><?php echo $liters; ?></td>
													                  	...
													                  	<td>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#remove_diesel2<?php echo $diesel_id; ?>'>
					                  											<i class='fa fa-trash-o'></i>
					                  										</button>
													                  	</td>
													            	</tr>
													            	...
													            	include("modal/remove_diesel2.php");
