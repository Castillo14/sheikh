	              					...
	              					<h3 class="box-title"><i class="fa fa-list"></i>Supplier 
	              						<span>
	              							<a class="btn-sm btn-primary navbar-btn right" href="#"><!-- btn btn-primary navbar-btn right Starts -->
	            								...
	            								$total = "SELECT * FROM tbl_supplier WHERE removed = 'No'";
	              					...
	              					<table class="table table-hover" id="ample2">
	                					...
	                					$jScript = md5(rand(1,9));
										 ...
										 $getUpdate = md5(rand(1,9));
	                						...
	                						$select_company = "SELECT * FROM tbl_supplier WHERE removed = 'No'";
	                					...
	                					<tr>
	                  						...
	                  						<td>
												...
												<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && remove_supplier=<?php echo $sup_id; ?> && getDelete=<?php echo $getDelete; ?>" class="btn btn-default btn-small">
