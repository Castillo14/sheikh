            ...
            <div class="panel-body">
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && drivers=<?php echo $edit_id; ?> && getDrivers=<?php echo $getAdd; ?>" class="btn btn-danger form-control">
                                Cancel
                            </a>
                        </div>
                    </div><!-- form-group Ends -->
...
<?php
        if(isset($_POST['submit'])){
            ...
            $insert_driver = "INSERT INTO tbl_driver (bus_company_id,first_name,middle_name,last_name,email_address,contact_number,address,image,created_by,date_created,removed,removed_by,date_removed) VALUES ('$e_id','$first_name','$middle_name','$last_name','$email_address','$contact_number','$address','$image','$creator',now(),'No','','0000-00-00')";
            $run_insert_driver = mysqli_query($con,$insert_driver);
                ...
                if($run_insert_driver){
                    ...
                    echo "
                        <script>
                            window.open('index.php?jScript=$jScript && newScript=$newScript && drivers=$edit_id && getDrivers=$getAdd','_self')
                        </script>
                    ";
