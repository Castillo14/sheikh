...
<div class="modal fade" id="remove_info3<?php echo $info_id; ?>" hidden="true" role="dialog">
	        <div class="modal-dialog">
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		...
	              		?>
	    				<form class="form-horizontal" action="remove_trip_info3.php" method="post" enctype="multipart/form-data">
