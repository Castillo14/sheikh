<?php
	...
	if(isset($_GET['expense_list'],$_GET['view_expense_list_company'])){

		$category_id = $_GET['expense_list'];
		$company_id = $_GET['view_expense_list_company'];
		$get_category = "SELECT * FROM tbl_expenses WHERE expenses_id = '$category_id' AND removed = 'No'";
...
?>
			<section class="content-header">
	    		...
	    		<section class="content">
	    			<a class="btn btn-default" href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && bus_company_expense=<?php echo $company_id; ?> && getUpdate=<?php echo $getUpdate; ?>">
						<i class="fa fa-reply"></i>
						Back
					</a>
					<a href="../PHPExcel/Examples/view_expense_list.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && view_expense_list=<?php echo $category_id; ?> && view_expense_list_company=<?php echo $company_id; ?> && getView=<?php echo $getUpdate; ?>" class="btn btn-default">
	    				<i class="fa fa-print"></i>
						Get Excel
	    			</a>
	    			<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && expense_list=<?php echo $category_id; ?> && view_expense_list_company=<?php echo $company_id; ?> && getUpdate=<?php echo $getUpdate; ?>" class="btn btn-default">
	    				<i class="fa fa-refresh"></i>
						Refresh
	    			</a>
	    			<form action="index.php?view_expense_list_search" method="POST" class="form-horizontal">
	              					...
	              					<h3 class="box-title"><i class="fa fa-industry"></i><?php echo $ee_name; ?> <?php echo $e_name; ?> List
	              						<span>
	              							<a class="btn-sm btn-primary navbar-btn right" href="#"><!-- btn btn-primary navbar-btn right Starts -->
	            								...
	            								$total = "SELECT * FROM tbl_trip_expense WHERE expenses_id = '$category_id' AND bus_company_id = '$company_id'";
	            				...
	            				<div class="box-body table-responsive no-padding">
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<?php
	                						...
	                						$select_sum = "SELECT SUM(price) AS total_sum FROM tbl_trip_expense WHERE bus_company_id = '$company_id' AND expenses_id = '$category_id'";
	                						...
	                						$select_company = "SELECT * FROM tbl_trip_expense WHERE expenses_id = '$category_id' AND bus_company_id = '$company_id'";
