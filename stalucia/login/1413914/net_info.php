...
?>
			<section class="content-header">
	    		...
	    		<section class="content">
					...
					<a class="btn btn-default" href="../PHPExcel/Examples/net_info.php?net_info=<?php echo $edit_id; ?>"
						<i class="fa fa-print"></i>
						Get Excel
					</a>
	    			<a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && net_info=<?php echo $edit_id; ?> && getRefresh=<?php echo $getUpdate; ?>" class="btn btn-default">
	    				<i class="fa fa-refresh"></i>
						Refresh
	    			</a>
	    			<form action="index.php?net_info_search" method="POST" class="form-horizontal">
	              					...
	              					<table class="table table-hover" id="ample2">
	                					...
	                					<?php
	                						...
	                						while($row=mysqli_fetch_array($run_select_company)){
												...
												$select_sum = "SELECT SUM(price) AS total_price FROM tbl_trip_expense WHERE trip_report_id = '$trip_report_id'";
		                						...
		                						$select_summm = "SELECT SUM(price) AS total_pricee FROM tbl_trip_expense WHERE bus_company_id = '$edit_id'";
		                						...
		                						$select_summ = "SELECT SUM(nb) AS total_nb, SUM(sb) AS total_sb FROM tbl_trip_report WHERE bus_company_id = '$edit_id'";
