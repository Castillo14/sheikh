...
<?php
	...
	if(isset($_GET['edit_supplier'])){
		...
		$edit_id = $_GET['edit_supplier'];
		$edit_bus = "SELECT * FROM tbl_supplier WHERE supplier_id = '$edit_id' AND removed = 'No'";
		$run_edit = mysqli_query($con,$edit_bus);
		$row_edit = mysqli_fetch_array($run_edit);
		$e_id = $row_edit['supplier_id'];
		$e_name = $row_edit['supplier_name'];
	}
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6">
                            <input type="submit" name="submit" value="Update Supplier" class="btn btn-primary form-control">
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label">
    ...
    <?php
    	if(isset($_POST['submit'])){
    		...
    		$bus_company_name = mysqli_real_escape_string($con,$_POST['bus_company_name']);
                $update_bus = "UPDATE tbl_supplier SET supplier_name = '$bus_company_name' WHERE supplier_id = '$e_id'";
