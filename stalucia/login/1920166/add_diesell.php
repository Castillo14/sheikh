<?php
	    	...
	    	$place = $_POST['place'];
	    		...
	    		$run_add_diesel = mysqli_query($con,"INSERT INTO tbl_diesel (bus_id,trip_report_id,liters,price,total_price,diesel_from,place,date_created) VALUES ('$bus_id','','$liters','$price','$total_pricee','$diesel','$place','$date_created')");
