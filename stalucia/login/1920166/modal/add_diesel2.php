<div class="modal fade" id="add_diesel2<?php echo $e_id; ?>" hidden="true" role="dialog">
	              		...
	              		<div class="row">
	              			<div class="box box-success">
	              						...
	              						<span>
	              							<a href="#" class="btn-sm btn-success navbar-btn right">
	              								<?php
	              									...
	              									$get_diesel = "SELECT * FROM tbl_diesel WHERE bus_id = '$diesel_bus_id' AND trip_report_id = '$trip_id'";
	              				...
	              				<div class="box-body table-responsive no-padding">
	              					<form action="add_diesel2.php" method="post" class="form-horizontal" enctype="multipart/form-data">
