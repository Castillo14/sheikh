...
<div class="modal fade" id="remove_expense<?php echo $trp_exp; ?>" hidden="true" role="dialog">
	        <div class="modal-dialog">
	            <div class="modal-content">
	              	...
	              	<div class="modal-body">
	              		...
	              		?>
	    				<form class="form-horizontal" action="remove_trip_expense.php" method="post" enctype="multipart/form-data">
