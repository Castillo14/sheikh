								...
								<form class='form-horizontal' action='' method='post'><!-- form-horizontal Starts -->
									...
									<div class='col-md-12'><!-- col-md-12 Starts -->
					                	...
					                	<div id='status_info' style='display: none;'><!-- status_info Starts -->
								        	<div class='col-md-12'>
									        	<button class='btn btn-default' type='button' data-toggle='modal' data-target='#add_expense3<?php echo $e_id; ?>'>
													<i class='fa fa-plus'></i>
													Add Expense
												</button>
												<?php

													            	include("modal/add_expense3.php");
													            ...
													            ?>
													            	<tr>
													            		...
													            		<td><?php echo $particulars; ?></td>
													                  	...
													                  	<td>
					                  										<button class='btn btn-default btn-small' type='button' data-toggle='modal' data-target='#remove_expense3<?php echo $trp_exp; ?>'>
													            	...
													            	include("modal/remove_expense3.php");
