...
<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php if(isset($_GET['dispatcher_bol'])){ echo "active"; } ?><?php if(isset($_GET['remove_bol'])){ echo "active"; } ?><?php if(isset($_GET['add_dispatcher_bol'])){ echo "active"; } ?><?php if(isset($_GET['dispatcher_bol_search'])){ echo "active"; } ?><">
                <a href="#!">
                    <i class="fa fa-industry"></i><span>BOL</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                                    ...
                                    ?>
                                    <li>
                                        <a href="index.php?jScript=<?php echo $jScript; ?> && newScript=<?php echo $newScript; ?> && dispatcher_bol=<?php echo $bus_company_id; ?> && getBOL=<?php echo $getBus; ?>"><i class="fa fa-industry"></i>
                                            <?php echo $bus_company_name; ?>
                                    </a>
                                    </li>
                                    <?php
            ...
            <li class="treeview <?php if(isset($_GET['add_edit_inventory_place'])){ echo "active"; } ?><?php if(isset($_GET['add_inventory_place'])){ echo "active"; } ?><?php if(isset($_GET['edit_inventory_place'])){ echo "active"; } ?><?php if(isset($_GET['remove_inventory_place'])){ echo "active"; } ?><?php if(isset($_GET['inventory'])){ echo "active"; } ?><?php if(isset($_GET['add_inventory'])){ echo "active"; } ?><?php if(isset($_GET['edit_inventory'])){ echo "active"; } ?><?php if(isset($_GET['remove_inventory'])){ echo "active"; } ?>">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="index.php?main_inventory"><i class="fa fa-list"></i>
                            Main Inventory
                        </a>
                    </li>
					 <li>
                        <a href="index.php?malabon_inventory"><i class="fa fa-list"></i>
                            Malabon Inventory
                        </a>
                    </li>
