...
<div class="col-sm-4">
<input type="tel" class="form-control" id="contact" name="contact" value="<?php echo $mobileno;?>" placeholder="Enter valid contact number..." minlength="15" maxlength="15" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$">
<span class="messages"></span>
</div>
