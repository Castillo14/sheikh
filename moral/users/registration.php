...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <label class="col-sm-2 col-form-label">Iqama No.</label>
        <div class="col-sm-4">
            <input class="form-control" type="number" name="iqama" id="iqama"
                        value="<?php if(isset($_GET['editid'])){ echo $rsedit['iqama']; } ?>" />
            <span class="messages"></span>
        </div>
    </div>
